...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.ClientKey = field.NewString(tableName, "client_key")
...
func (p *project) updateTableName(table string) *project {
	...
	p.ClientKey = field.NewString(table, "client_key")
...
func (p *project) fillFieldMap() {
	...
	p.fieldMap["server_key"] = p.ServerKey
	p.fieldMap["client_key"] = p.ClientKey
